...
/**
 *
 * This class shows the techniques of EditText combine RxJava
 *
 * Create three subjects and make the clickPublish use the operator: withLatestFrom for gather the two observables from
 * titlePublisher & messagePublisher
 * [Tutorial: EditText and onTextChanged](https://blog.csdn.net/vitaviva/article/details/107879099)
 */
